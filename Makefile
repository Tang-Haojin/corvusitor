...
test_corvus_yuquan: yuquan_build $(TEST_CORVUS_YUQUAN_BIN) $(CORVUSITOR_BIN)
...
test_corvus_yuquan_cmodel: yuquan_build $(TEST_CORVUS_YUQUAN_CMODEL_BIN) $(CORVUSITOR_BIN)
