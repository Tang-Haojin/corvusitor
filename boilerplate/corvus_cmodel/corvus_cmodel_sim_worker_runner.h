...
public:
    explicit CorvusCModelSimWorkerRunner(std::vector<std::shared_ptr<CorvusCModelSimWorker>> simWorkers);
...
private:
    std::vector<std::shared_ptr<CorvusCModelSimWorker>> simWorkers;
